...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('guild_id', models.BigIntegerField(help_text='Guild ID on Discord', primary_key=True, serialize=False)),
                ('server_name', models.CharField(blank=True, db_index=True, default='', help_text='Server Name', max_length=32)),
                ('sync_names', models.BooleanField(default=False, help_text='Sync Auth Main Name to Discord.')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guild', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aadiscordmultiverse.discordmanagedserver')),
                ('user', models.ForeignKey(help_text='Auth user owning this Discord account', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
